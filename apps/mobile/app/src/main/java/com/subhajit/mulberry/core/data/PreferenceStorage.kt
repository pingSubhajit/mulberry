...
object PreferenceStorage {
    ...
    val partnerUserId = stringPreferencesKey("partner_user_id")
    ...
    val canvasMode = stringPreferencesKey("canvas_mode")
    val canvasModeNextToggleAt = stringPreferencesKey("canvas_mode_next_toggle_at")
    val dedicatedCanvasAvailable = booleanPreferencesKey("dedicated_canvas_available")
