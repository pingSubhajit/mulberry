...
object TestTags {
    ...
    const val HOME_OPEN_WALLPAPER_BUTTON = "home_open_wallpaper_button"
    const val HOME_WALLPAPER_HELP_LINK = "home_wallpaper_help_link"
    const val HOME_ENTER_CODE_BUTTON = "home_enter_code_button"
    const val HOME_JOIN_CODE_SHEET = "home_join_code_sheet"
    const val HOME_JOIN_CODE_SUBMIT_BUTTON = "home_join_code_submit_button"
    const val HOME_PAIRING_CONFIRMED_SHEET = "home_pairing_confirmed_sheet"
    ...
    const val REACTION_RAIL = "reaction_rail"
    ...
    const val WALLPAPER_OPEN_WALLPAPER_BUTTON = "wallpaper_open_wallpaper_button"
    const val WALLPAPER_SELECT_BACKGROUND_BUTTON = "wallpaper_select_background_button"
    const val WALLPAPER_CLEAR_BACKGROUND_BUTTON = "wallpaper_clear_background_button"
    const val WALLPAPER_REFRESH_SNAPSHOT_BUTTON = "wallpaper_refresh_snapshot_button"
