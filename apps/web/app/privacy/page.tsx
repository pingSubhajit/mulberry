      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-5 pb-24 sm:px-8 lg:grid-cols-[16rem_1fr] lg:px-10">
        ...
        <article className="grid gap-14">
          ...
          {policy.sections.map((section) => (
            ...
            >
              <h2 className="text-3xl font-semibold leading-tight tracking-[-0.055em] text-brand-ink sm:text-4xl">
                {section.title}
              </h2>
                  ...
                  if (block.type === "subheading") {
                    return (
                      <h3
                        ...
                        className="pt-3 text-xl font-semibold tracking-[-0.035em] text-brand-ink"
                      >
                        {block.text}
                      </h3>
                    )
